...
import { ViewPlanes } from "./components/view";
import { DeletePlane } from "./components/delete";
import { CreatePlanes } from "./components/create";
import { UpdatePlanes } from "./components/update";

export const PlanesCrudPage = () => {
      ...
      <div className="flex flex-col space-y-8 lg:flex-row lg:space-x-12 lg:space-y-0 h-auto">
        ...
        <div className="flex-1 lg:max-w-4xl my-10">
          <div className="space-y-6">
            <Routes>
              <Route path="view" element={<ViewPlanes />} />
              <Route path="create" element={<CreatePlanes />} />
              <Route path="update" element={<UpdatePlanes />} />
              <Route path="delete" element={<DeletePlane />} />
            </Routes>
          </div>
        </div>
      </div>
